...
<form action="<?php echo base_url('ajuda/insert') ?>" method="post" name="form1" class="form1">
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="3" class="tabela_principal" style="padding:10px;">
		...
		<tr>
			...
			<td width="90%" valign="middle">
				<div class="col-lg-4 col-md-8 inputs">
					<input name="titulo" type="text" class="form-control" id="" placeholder="Ex: Como lançar horas?" value="<?php echo set_value("titulo"); ?>" />
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="90%" valign="middle">
				<div class="col-lg-6 col-md-9 inputs">
					<textarea name="texto" class="form-control" id="texto_ajuda"><?php echo set_value("texto"); ?></textarea>
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td width="90%" valign="middle">
				<div class="col-lg-4 col-md-8 inputs">
					<input name="tipo" type="text" class="form-control" id="" placeholder="Ex: Lançar Etapa" value="<?php echo set_value("tipo"); ?>" />
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td style="padding-left:14px">
				<input name="submit" type="submit" class="btn btn-primary" id="submit" value="Cadastrar Ajuda" />
			</td>
		</tr>
...
<script>$("#texto_ajuda").jqte({ol: false, ul: false, format: false});</script>